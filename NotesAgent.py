...
# Clear the temp folder when the session ends
if st.session_state.get("clear_temp", False):
    clear_temp_folder()
    ...
    if st.button("Generate Notes"):
        with st.spinner("Extracting text from PDF..."):
            ...
            if st.download_button(
                ...
                st.session_state.clear_temp = True  # Set flag to clear temp folder
...
# Clear the temp folder when the session ends
st.session_state.clear_temp = True
